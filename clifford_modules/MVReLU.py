...
class MVReLU(nn.Module):
    def __init__(self, algebra, channels, invariant="mag2", exclude_dual=False):
        ...
        # Removing learned parameters a and b, as ReLU doesn't require these shifts and scalings.
        # If still need them, you can uncomment the next two lines.
    ...
    def forward(self, input):
        ...
        # If you kept a and b, include their influence:
